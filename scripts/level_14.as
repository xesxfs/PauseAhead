package
{
   ...
   public class level_14 extends World
   {
      ...
      public function level_14()
      {
         ...
         add(new obj_door(608,96));
         if(global.speedrunning == true)
         {
            add(new obj_trinket(352 + 16,288));
         }
         else
         {
            add(new obj_hourglass(352 + 16,288));
         }
         add(new obj_block(0,448,9,1));
         add(new obj_block(288,352,8,4));
         add(new obj_block(544,192,6,5));
         add(new obj_block(0,320,6,1));
         add(new obj_block(288,224,1,4));
         add(new obj_block(96,192,7,1));
         add(new obj_block(416,96,1,5));
         add(new obj_block(0,64,23,1));
      }
