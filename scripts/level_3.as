package
{
   ...
   public class level_3 extends World
   {
      ...
      public function level_3()
      {
         ...
         global.room_width = 1000;
         global.room_height = 520;
         add(global.player = new obj_player(32,357));
         ...
         if(global.speedrunning == true)
         {
            add(new obj_trinket(416,224));
         }
         add(new obj_flower(832 - 36,352 - 2,0));
         add(new obj_flower(832 - 20,352 + 2,0));
         add(new obj_flower(960 - 12,352,0));
         add(new obj_flower(96,384,2));
         add(new obj_door(864,288));
         add(new obj_spikes(416,416));
         add(new obj_spikes(128,416));
         ...
         add(new obj_invertspikes(128,192));
         add(new obj_invertspikes(160,192));
         add(new obj_invertspikes(192,192));
         add(new obj_invertspikes(224,192));
         add(new obj_invertspikes(256,192));
         ...
         add(new obj_sawleft(576 - 28,416 - 28));
         add(new obj_sawleft(320 - 28,448 - 28));
         add(new obj_block(768,384,8,3));
         add(new obj_block(480,416,9,2));
         add(new obj_block(448,384,1,3));
         add(new obj_block(128,448,10,1));
         add(new obj_block(0,416,4,2));
         add(new obj_block(448,192,18,2));
         add(new obj_block(128,160,10,1));
         add(new obj_block(0,192,4,1));
      }
