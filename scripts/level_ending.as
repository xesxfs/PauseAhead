package
{
   ...
   public class level_ending extends World
   {
       
      
      private var sharedOBJ:SharedObject;
      
      public function level_ending()
      {
         var i:obj_speedruntimer = null;
         super();
         FP.screen.color = 0;
