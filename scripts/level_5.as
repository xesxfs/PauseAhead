package
{
   ...
   public class level_5 extends World
   {
      ...
      public function level_5()
      {
         ...
         add(global.player = new obj_player(32,133));
         ...
         add(new obj_fireflygrove(464 + 12,64 + 12 + 12,4));
         add(new obj_flower(464,128,1));
         add(new obj_door(512,64));
         add(new obj_spikes(192,416));
         add(new obj_spikes(224,416));
         add(new obj_spikes(256,416));
         add(new obj_spikes(288,416));
         add(new obj_spikes(320,416));
         add(new obj_spikes(352,416));
         add(new obj_spikes(384,416));
         add(new obj_spikes(416,416));
         add(new obj_block(192,448,8,1));
         add(new obj_block(448,160,6,10));
         add(new obj_block(0,192,6,9));
      }
