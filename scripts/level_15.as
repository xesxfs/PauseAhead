package
{
   ...
   public class level_15 extends World
   {
      ...
      public function level_15()
      {
         ...
         global.room_width = 1220;
         global.room_height = 480;
         add(global.player = new obj_player(96,357));
         ...
         add(new obj_door(1024,320));
         add(new obj_spikes(480,384));
         add(new obj_spikes(512,384));
         add(new obj_spikes(544,352));
         add(new obj_spikes(576,224));
         add(new obj_spikes(672,224));
         add(new obj_spikes(704,352));
         add(new obj_spikes(736,384));
         add(new obj_spikes(768,384));
         add(new obj_invertspikes(480,128));
         add(new obj_invertspikes(512,128));
         add(new obj_invertspikes(608,128));
         add(new obj_invertspikes(640,128));
         add(new obj_invertspikes(736,128));
         add(new obj_invertspikes(768,128));
         add(new obj_thwomp(416,161));
         add(new obj_thwomp(448,129));
         add(new obj_thwomp(800,129));
         add(new obj_thwomp(832,161));
         add(new obj_bigthwomp(352,353));
         add(new obj_bigthwomp(864,353));
         add(new obj_bigthwomp(608,289));
         if(global.speedrunning == true)
         {
            add(new obj_trinket(640 - 12,192));
         }
         else
         {
            add(new obj_hourglass(640,192));
         }
         add(new obj_block(672,288,1,3));
         add(new obj_block(608,256,3,1));
         add(new obj_block(544,384,6,1));
         add(new obj_block(576,256,1,4));
         add(new obj_block(1152,320,1,3));
         add(new obj_block(928,288,7,1));
         add(new obj_block(864,160,2,6));
         add(new obj_block(832,128,1,1));
         add(new obj_block(448,96,12,1));
         add(new obj_block(416,128,1,1));
         add(new obj_block(32,416,35,1));
         add(new obj_block(352,160,2,6));
         add(new obj_block(64,288,9,1));
         add(new obj_block(32,320,1,3));
      }
