package
{
   ...
   public class obj_menu_logo2 extends Entity
   {
       
      
      private const MP:Class = obj_menu_logo2_MP;
      
      public var z:Image;
      
      public var scaleplus:Number = 0;
      
      public function obj_menu_logo2()
      {
         super();
         x = 260;
         y = 410;
      ...
      override public function update() : void
      {
         ...
         if(FP.world.mouseY > y - this.z.height / 2 && FP.world.mouseY < y + this.z.height / 2 && FP.world.mouseX > x - this.z.width / 2 && FP.world.mouseX < x + this.z.width / 2 && global.yesno == false)
         {
            ...
            if(Input.mousePressed)
            {
               ...
               {
                  navigateToURL(new URLRequest("http://www.askiisoft.com/"),"_blank");
               }
            }
         }
         else
