package
{
   ...
   public class level_10 extends World
   {
      ...
      public function level_10()
      {
         ...
         global.room_height = 896;
         add(global.player = new obj_player(416,37));
         ...
         add(new obj_door(736,544));
         add(new obj_thwomp(64,320));
         add(new obj_thwomp(96,320));
         add(new obj_thwomp(192,640));
         add(new obj_thwomp(224,640));
         add(new obj_thwomp(512,129));
         add(new obj_bigthwomp(768,33));
         add(new obj_bigthwomp(544,577));
         add(new obj_bigthwomp(672,545));
         add(new obj_bigthwomp(416,481));
         add(new obj_block(32,0,12,4));
         add(new obj_block(416,0,14,1));
         add(new obj_block(416,96,11,1));
         add(new obj_block(544,128,3,6));
         add(new obj_block(640,256));
         add(new obj_block(672,224));
         add(new obj_block(704,192));
         add(new obj_block(736,128,1,2));
         add(new obj_block(832,32,1,19));
         add(new obj_block(32,128,1,13));
         add(new obj_block(128,224,12,8));
         add(new obj_block(64,544,4,10));
         add(new obj_block(256,480,5,9));
         add(new obj_block(192,864,17,1));
         add(new obj_block(512,384,8,3));
         add(new obj_block(480,480,2,2));
         add(new obj_block(544,544,2,1));
         add(new obj_block(608,544,2,8));
         add(new obj_block(480,640,2,7));
         add(new obj_block(640,448,6,3));
         add(new obj_block(736,640,4,8));
      }
