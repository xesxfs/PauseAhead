package
{
   ...
   public class level_23 extends World
   {
       
      
      private var sharedOBJ:SharedObject;
      
      public function level_23()
      {
         var i:int = 0;
         super();
         FP.screen.color = 0;
         ...
         add(global.player = new obj_player(120,10));
         ...
         add(global.boss = new obj_boss());
         add(new obj_blackfade());
         add(new obj_bossbutton(64,448 - 86));
         add(new obj_bossbutton(640 - 64 - 40,448 - 86));
         i = 0;
         add(new obj_block(0,448,20,1));
      }
