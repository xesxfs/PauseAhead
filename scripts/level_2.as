package
{
   ...
   public class level_2 extends World
   {
      ...
      public function level_2()
      {
         ...
         add(new obj_block(608,320,3,1));
         add(new obj_block(768,416,3,1));
         add(new obj_block(608,512,3,1));
         add(new obj_block(512,608,12,1));
         add(new obj_block(192,448,10,6));
         add(new obj_block(0,128,6,10));
      }
