package
{
   ...
   public class level_20 extends World
   {
       
      
      private var sharedOBJ:SharedObject;
      
      public function level_20()
      {
         super();
         ...
         if(global.speedrunning == true)
         {
            add(new obj_trinket(176 * 2,400 * 2));
         }
         global.room_width = 640;
         global.room_height = 1200;
         add(global.player = new obj_player(64,133));
         ...
         add(new obj_door(416,1056));
         add(new obj_spikes(192,480));
         add(new obj_spikes(416,480));
         add(new obj_spikes(384,672));
         add(new obj_spikes(224,672));
         add(new obj_spikes(256,864));
         add(new obj_spikes(352,864));
         add(new obj_sawleft(240,356));
         add(new obj_sawleft(256,548));
         add(new obj_sawleft(288,740));
         add(new obj_sawleft(496,996));
         add(new obj_ceilingsawright(344,260));
         add(new obj_ceilingsawright(568,100,true));
         add(new obj_ceilingsawright(296,1028));
         add(new obj_bigthwomp(288,33));
         add(new obj_block(0,0,20,1));
         add(new obj_block(288,1152,9,1));
         add(new obj_block(576,992,1,5));
         add(new obj_block(384,928,6,2));
         add(new obj_block(352,896,1,6));
         add(new obj_block(384,704,1,6));
         add(new obj_block(416,512,1,6));
         add(new obj_block(448,192,6,10));
         add(new obj_block(256,896,1,8));
         add(new obj_block(224,704,1,6));
         add(new obj_block(192,512,1,6));
         add(new obj_block(0,192,6,10));
      }
