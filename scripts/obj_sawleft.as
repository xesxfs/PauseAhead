package
{
   ...
   public class obj_sawleft extends Entity
   {
       
      
      private const SAW2:Class = obj_sawleft_SAW2;
      ...
      public function obj_sawleft(nx:int, ny:int)
      {
         this.sprite_index = new Spritemap(this.SAW2,56,56);
         super();
         x = nx;
         y = ny;
         this.basex = x;
