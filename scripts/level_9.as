package
{
   ...
   public class level_9 extends World
   {
      ...
      public function level_9()
      {
         ...
         if(global.level_9_text == false)
         {
            add(new obj_blacktext());
         }
         add(new obj_replaystatic());
         global.room_width = 800;
         global.room_height = 736;
         add(global.player = new obj_player(128,485));
         ...
         add(new obj_door(672,96));
         add(new obj_sawleft(388,612));
         add(new obj_ceilingsawleft(388,612));
         add(new obj_sawleft(580,612));
         add(new obj_ceilingsawleft(580,612));
         add(new obj_sawleft(484,516));
         add(new obj_ceilingsawleft(484,516));
         add(new obj_sawleft(292,388));
         add(new obj_ceilingsawleft(292,388));
         add(new obj_ceilingsawleft(580,388));
         add(new obj_sawleft(580,388));
         add(new obj_block(608,64,6,1));
         add(new obj_block(256,64,11,10));
         add(new obj_block(256,384,1,2));
         add(new obj_block(672,192,4,15));
         add(new obj_block(288,672,12,2));
         add(new obj_block(0,544,9,4));
         add(new obj_block(480,448,6,2));
         add(new obj_block(416,576,6,1));
         add(new obj_block(352,480,2,4));
