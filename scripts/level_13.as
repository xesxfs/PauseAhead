package
{
   ...
   public class level_13 extends World
   {
      ...
      public function level_13()
      {
         ...
         add(global.player = new obj_player(288,709));
         ...
         add(new obj_secretdoor());
         add(new obj_helleye(276 - 18,672 - 12));
         add(new obj_helleye(276 + 18 + 8 + 4,672 - 12));
         add(new obj_door(0,256));
         add(new obj_spikes(384,320));
         add(new obj_spikes(416,320));
         add(new obj_spikes(0,736));
         add(new obj_spikes(32,736));
         add(new obj_spikes(64,736));
         add(new obj_spikes(96,736));
         add(new obj_spikes(128,736));
         add(new obj_spikes(160,736));
         add(new obj_spikes(192,736));
         add(new obj_spikes(224,736));
         add(new obj_spikes(256,736));
         add(new obj_spikes(352,736));
         add(new obj_spikes(384,736));
         add(new obj_spikes(416,736));
         add(new obj_spikes(448,736));
         add(new obj_spikes(480,736));
         add(new obj_spikes(512,736));
         add(new obj_spikes(544,736));
         add(new obj_spikes(576,736));
         add(new obj_spikes(512,224));
         add(new obj_spikes(544,224));
         add(new obj_spikes(576,224));
         add(new obj_spikes(608,224));
         add(new obj_spikes(416,64));
         add(new obj_spikes(448,64));
         add(new obj_spikes(256,64));
         add(new obj_spikes(160,320));
         add(new obj_spikes(128,320));
         add(new obj_spikes(96,64));
         add(new obj_spikes(64,64));
         add(new obj_spikes(32,64));
         add(new obj_spikes(0,64));
         add(new obj_spikes(192,64));
         add(new obj_spikes(224,64));
         add(new obj_spikes(288,64));
         add(new obj_spikes(352,64));
         add(new obj_spikes(384,64));
         add(new obj_spikes(320,64));
         add(new obj_spikes(96,320));
         add(new obj_spikes(608,736));
         add(new obj_invertspikes(192,416));
         add(new obj_invertspikes(224,416));
         add(new obj_invertspikes(128,480));
         add(new obj_invertspikes(160,480));
         add(new obj_invertspikes(64,544));
         add(new obj_invertspikes(96,544));
         add(new obj_invertspikes(0,608));
         add(new obj_invertspikes(32,608));
         add(new obj_invertspikes(384,416));
         add(new obj_invertspikes(416,416));
         add(new obj_invertspikes(480,480));
         add(new obj_invertspikes(512,544));
         add(new obj_invertspikes(544,544));
         add(new obj_invertspikes(576,608));
         add(new obj_invertspikes(608,608));
         add(new obj_invertspikes(256,160));
         add(new obj_invertspikes(288,160));
         add(new obj_invertspikes(320,160));
         add(new obj_invertspikes(352,160));
         add(new obj_invertspikes(384,160));
         add(new obj_invertspikes(416,160));
         add(new obj_invertspikes(448,480));
         add(new obj_invertspikes(448,160));
         add(new obj_sawright(196,740));
         add(new obj_sawright(132,740));
         add(new obj_sawright(68,740));
         add(new obj_sawright(4,740));
         add(new obj_sawleft(372,740));
         add(new obj_sawleft(436,740));
         add(new obj_sawleft(500,740));
         add(new obj_sawleft(564,740));
         add(new obj_bigthwomp(288,161));
         add(new obj_block(0,768,20,1));
         add(new obj_block(576,544,2,2));
         add(new obj_block(512,256,4,9));
         add(new obj_block(448,416,2,2));
         add(new obj_block(384,352,4,2));
         add(new obj_block(256,96,7,2));
         add(new obj_block(192,96,2,10));
         add(new obj_block(128,352,2,4));
         add(new obj_block(64,352,2,6));
         add(new obj_block(0,352,2,8));
         add(new obj_block(0,96,4,5));
      }
