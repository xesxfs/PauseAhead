package
{
   ...
   public class level_12 extends World
   {
      ...
      public function level_12()
      {
         ...
         add(new obj_bigthwomp(0,65));
         add(new obj_bigthwomp(64,65));
         add(new obj_bigthwomp(128,65));
         add(new obj_bigthwomp(192,65));
         add(new obj_bigthwomp(384,1));
         add(new obj_bigthwomp(448,1));
         add(new obj_block(384,-32,4,1));
         add(new obj_block(384,192,4,8));
         add(new obj_block(256,256,4,3));
         add(new obj_block(128,352,4,3));
         add(new obj_block(0,448,19,1));
         add(new obj_block(608,64,1,13));
         add(new obj_block(512,0,4,2));
         add(new obj_block(0,0,12,2));
      }
