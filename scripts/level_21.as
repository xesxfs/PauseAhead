package
{
   ...
   public class level_21 extends World
   {
       
      
      private var sharedOBJ:SharedObject;
      
      public function level_21()
      {
         super();
         global.achievementQueue.push(9);
         ...
         if(global.speedrunning == true)
         {
            add(new obj_trinket(64,64));
         }
         add(new obj_fireflygrove(400,264 - 60,4));
         add(new obj_flower(384,288 - 60,1));
         add(new obj_flower(120 + 20,416 - 60,0));
         add(new obj_flower(140 + 8 + 2 + 20,414 - 60,0));
         add(new obj_flower(136 + 8 + 20 + 20,416 - 60,0));
