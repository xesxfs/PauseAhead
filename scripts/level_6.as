package
{
   ...
   public class level_6 extends World
   {
      ...
      public function level_6()
      {
         ...
         global.room_width = 1020;
         global.room_height = 640;
         add(global.player = new obj_player(192,485));
         ...
         add(new obj_door(928,32));
         add(new obj_spikes(544,512));
         add(new obj_spikes(608,512));
         add(new obj_spikes(576,512));
         add(new obj_spikes(736,448));
         add(new obj_spikes(544,384));
         add(new obj_spikes(736,288));
         add(new obj_spikes(544,192));
         add(new obj_spikes(0,160));
         add(new obj_spikes(32,160));
         add(new obj_spikes(160,160));
         add(new obj_spikes(128,160));
         add(new obj_spikes(96,160));
         add(new obj_invertspikes(544,448));
         add(new obj_invertspikes(576,448));
         add(new obj_invertspikes(704,352));
         add(new obj_invertspikes(736,352));
         add(new obj_invertspikes(544,256));
         add(new obj_invertspikes(576,256));
         add(new obj_invertspikes(704,224));
         add(new obj_invertspikes(736,224));
         add(new obj_invertspikes(544,32));
         add(new obj_invertspikes(576,32));
         add(new obj_invertspikes(288,32));
         add(new obj_invertspikes(256,32));
         ...
         add(new obj_invertspikes(448,448));
         add(new obj_invertspikes(480,448));
         add(new obj_invertspikes(512,448));
         add(new obj_invertspikes(128,32));
         add(new obj_sawleft(804,164));
         add(new obj_bigthwomp(320,353));
         add(new obj_bigthwomp(384,353));
         add(new obj_bigthwomp(640,33));
         add(new obj_block(544,0,15,1));
         add(new obj_block(64,0,8,1));
         add(new obj_block(448,352,3,3));
         add(new obj_block(320,0,7,11));
         add(new obj_block(704,320,2,1));
         add(new obj_block(544,416,2,1));
         add(new obj_block(544,224,2,1));
         add(new obj_block(704,192,2,1));
         add(new obj_block(704,160,1,1));
         add(new obj_block(928,128,3,2));
         add(new obj_block(768,192,5,9));
         add(new obj_block(704,480,2,3));
         add(new obj_block(192,544,16,1));
         add(new obj_block(0,192,6,11));
      }
