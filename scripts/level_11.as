package
{
   ...
   public class level_11 extends World
   {
      ...
      public function level_11()
      {
         ...
         {
            add(new obj_trinket(416,228 - 12));
         }
         add(global.muteObj);
         if(global.speedrunning == true)
         {
         ...
         global.room_width = 992;
         global.room_height = 480;
         add(global.player = new obj_player(32,293));
         ...
         add(new obj_door(896,128));
         add(new obj_invertspikes(864,96));
         add(new obj_invertspikes(896,96));
         add(new obj_invertspikes(928,96));
         add(new obj_invertspikes(960,96));
         add(new obj_sawright(196,324));
         add(new obj_sawright(452,324));
         add(new obj_sawleft(708,388));
         add(new obj_sawleft(388,324));
         add(new obj_ceilingsawleft(36,196));
         add(new obj_ceilingsawleft(420,164));
         add(new obj_block(864,64,4,1));
         add(new obj_block(640,64,7,9));
         add(new obj_block(416,160,7,1));
         add(new obj_block(896,224,3,7));
         add(new obj_block(576,416,10,1));
         add(new obj_block(0,352,18,2));
         add(new obj_block(0,320,1,1));
         add(new obj_block(544,288,1,2));
         add(new obj_block(288,288,1,2));
         add(new obj_block(384,224,1,1));
         add(new obj_block(0,224,1,1));
         add(new obj_block(0,160,13,2));
      }
