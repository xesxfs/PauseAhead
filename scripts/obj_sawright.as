package
{
   ...
   public class obj_sawright extends Entity
   {
       
      
      private const SAW1:Class = obj_sawright_SAW1;
      ...
      public function obj_sawright(nx:int, ny:int)
      {
         this.sprite_index = new Spritemap(this.SAW1,56,56);
         super();
         x = nx;
         y = ny;
         this.basex = x;
